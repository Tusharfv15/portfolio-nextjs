...
export default function Contact() {
  return (
    <section className="py-section-padding px-8 bg-surface-container-lowest" id="contact">
      <div className="max-w-7xl mx-auto text-center space-y-stack-md reveal-on-scroll">
        ...
        <h2 className="font-display text-display text-white">Start a Conversation</h2>
